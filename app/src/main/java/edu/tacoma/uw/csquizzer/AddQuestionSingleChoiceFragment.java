...
/**
 * The purpose of AddQuestionSingleChoiceFragment module is to add a new single choice question
 * to database
 *
 * @author  Phuc Pham N
 * @version 1.0
 * @since   2020-08-17
 */
public class AddQuestionSingleChoiceFragment extends Fragment {
    ...
    public AddQuestionSingleChoiceFragment(Context mContext, String mTypeId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_add_question_single_choice, container, false);
        ...
        radioButtonAnswer1 = rootView.findViewById(R.id.radio_answer_1);
    ...
    private class AddQuestion extends AsyncTask<Void, Void, Boolean> {
        ...
        public AddQuestion(Context mContext, String mQuestionTitle,  String mQuestionBody,
                          ...
                          String mCourseId, String mTopicId, String mDifficultyId,
                           String mTypeId, String mAnswer, MyInterface mListener) {
            this.context = mContext;
